...
describe("Testing decodeDeal", () => {
  it("Testing the first deal", () => {
    ...
    expect(deal.N).toStrictEqual(StringParser.parseHand("AKQJT98765432..."));

    expect(deal.E).toStrictEqual(StringParser.parseHand(".AKQJT98765432.."));

    expect(deal.S).toStrictEqual(StringParser.parseHand("..AKQJT98765432."));

    expect(deal.W).toStrictEqual(StringParser.parseHand("...AKQJT98765432"));
  });
